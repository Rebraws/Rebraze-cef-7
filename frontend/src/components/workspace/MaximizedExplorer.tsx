...
const MaximizedExplorer: React.FC<FileSystemExplorerProps> = (props) => {
  ...
  return (
    <aside 
      className="w-full flex-1 bg-[#FDFBF7] border-r border-gray-200 flex flex-col z-10 animate-in fade-in duration-300" 
    ...
    >
      <div className="p-3 flex items-center justify-between border-b border-gray-200 shrink-0">
        ...
        <div className="flex items-center gap-2">
           ...
           <button onClick={() => setMode('sidebar')} className="p-2 text-gray-500 hover:bg-gray-100 rounded-lg transition-colors ml-2" title="Collapse View"><Minimize2 size={18} /></button>
        </div>
      </div>
